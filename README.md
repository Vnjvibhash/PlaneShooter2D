...
```
cd existing_repo
git remote add origin https://gitlab.com/Vivekajee/plane-shooter-2d-game.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Vivekajee/plane-shooter-2d-game/-/settings/integrations)
